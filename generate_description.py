...
async def generate_description(image_data, selected_voice_name, description_history):
    ...
    try:
        system_prompt = f"You are {selected_voice_name} and you must describe the image you are given using your unique phrases in a humorous way in 15 words or less. Please use only raw text without any special formatting characters like asterisks. Some previous image descriptions from other people will now be given, do not just repeat what is said: {' '.join(description_history)}"
